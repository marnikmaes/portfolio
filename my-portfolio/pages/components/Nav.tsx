            ...
            <div className="max-w-screen mx-auto px-8 h-[40px]">
                <div className="flex justify-between py-8">
                    <div className="flex items-center space-x-1">
                        <Link href={"/"} className='text-2xl font-Roboto font-semibold px-5 bg-customWhite'>
                    ...
                    <div className="hidden px-5 lg:flex items-center space-x-1 text-xl font-Roboto font-semibold">
                    ...
                    <div className="lg:hidden flex items-center px-3 pr-5">
                        <button className="mobile-menu-button" onClick={toggleMobile}>
                            <Icon className="w-16 h-16 text-customBlack" icon="charm:menu-hamburger" />
                        </button>
                    </div>
                </div>
            </div>
